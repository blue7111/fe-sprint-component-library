...
export const DividerContainer = styled.div`
  padding: ${Spacing[12].value}px;
  color: ${Gray[700].value};
  border-bottom: ${divideBorderBottom.width.value}px
    ${divideBorderBottom.style.value} ${divideBorderBottom.color.value}; // 아래쪽에 구분선 스타일 적용
`;
